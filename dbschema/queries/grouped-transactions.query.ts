...
export type GroupedTransactionsArgs = {
  "pIds": string[];
  "cIds": string[];
  "lIds": string[];
  "isOverall": boolean;
...
export type GroupedTransactionsReturns = {
  "key": {
    "category": {
      "id": string;
      "name": string;
...
export async function groupedTransactions(client: Executor, args: GroupedTransactionsArgs): Promise<GroupedTransactionsReturns> {
  return client.query(`\
WITH
