...
export type GroupedTransactionsByDateArgs = {
  "pIds": string[];
  "cIds": string[];
  "lIds": string[];
  "isOverall": boolean;
...
export type GroupedTransactionsByDateReturns = {
  "key": {
    "date_str": string;
    "is_positive": boolean;
  };
...
export async function groupedTransactionsByDate(client: Executor, args: GroupedTransactionsByDateArgs): Promise<GroupedTransactionsByDateReturns> {
  return client.query(`\
WITH
